...
REGISTRY = (
    EffectRegistration("clock-hand", "rotating radial XY hand", {"rotation_seconds": 12, "width_mm": 300}, "clock"),
    EffectRegistration("expanding-rings", "true XYZ spherical shell", {"origin": "centre", "speed_mps": 1.0, "thickness_mm": 250}, "spatial"),
    EffectRegistration("height-wave", "moving horizontal Z band", {"direction": "bounce", "speed_mps": 0.8, "height_mm": 300}, "spatial"),
    ...
    EffectRegistration("rotating-plane", "soft signed-distance rotating plane", {"axis": "tilted", "rotation_seconds": 10, "thickness_mm": 220, "trail_degrees": 20, "direction": "clockwise"}, "procedural"),
