...
def _run_procedural_effect(args: argparse.Namespace) -> int:
    if args.command not in {"Fire", "RotatingPlane", "Radar", "Aurora", "Fireflies", "Twinkle"}:
...
def _main(args: argparse.Namespace) -> int:
    ...
    if args.area == "effect":
        ...
        if args.command in {"Fire", "RotatingPlane", "Radar", "Aurora", "Fireflies", "Twinkle"}: return _run_procedural_effect(args)
