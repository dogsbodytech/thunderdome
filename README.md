...
In 2024 [we built a huge geodesic dome](https://www.dogsbody.com/blog/electromagnetic-field-2024-the-best-yet/) and in 2026 we aim to cover the entire thing in addressable RGB LEDs for interactive lighting, patterns, games, and general tinkering! 
...
Full information can be found in the [dome/README.md](dome/README.md)
...
Full information can be found in the [lighting/README.md](lighting/README.md)
